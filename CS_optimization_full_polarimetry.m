...
%% plot
HH_s_time_result1=migration_and_plot_polarization(HH_s_time_result,f, horzcat(HH_name,'_HH'),depth_start,depth_end);
%%
%VV_s_time_result1=migration_and_plot_polarization(VV_s_time_result,f, horzcat(VV_name,'_VV'),0.26,0.35);
%% 
%%
%HV_s_time_result1 =migration_and_plot_polarization(s_HV_re,f, horzcat(HV_name,'_HV'),0,1);
%%
