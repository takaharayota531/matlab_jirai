...
% WHEN="0124";
WHEN="通常の"
experiment_content=  "のgradient_descent_window="+window_size+",r="+r+",t="+t
IF_RANGE
window_size
tic
[s_result,s_his,h_his,alpha_his,df_his,f_list]=gradient_descent(input_data_array,sample,model,p);
% ans_tim=toc
ans_tim=toc

%%
plot(f_list)
title('評価関数普通のgradient_descent')
xlabel('試行回数')
ylabel('f')
...
%% 最適化後の結果表示
 ...
 input_string=horzcat(dataFolder,experiment_content,WHEN)
