...
%% model_check
model_check=make_model_alongline(8,s_time_filtered_sq);

%% interpolate
  a=10000;
  scattering_interpolated=interpolate_calculate(s_time_sampled_sq,index,dl,x_int,sparse_k,a);
  %% model_check_interpolated
  model_check_interpolated=make_model_alongline(16,scattering_interpolated);
%% true plot
f=figure;
f1=figure;
% f2=figure;
% f3=figure;
show_w_search_plot(model_check,s_time_filtered_sq(:,index_distance),f);
%show_w_search_plot(model_check_interpolated,scattering_interpolated(:,index_distance),f1);
