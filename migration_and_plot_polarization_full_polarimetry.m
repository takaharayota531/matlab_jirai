...
function [s_time_ans,index_distance]= migration_and_plot_polarization_full_polarimetry(s,f,dataname,depth_start,depth_end,IF_RANGE,IF_PLOT)
    ...
    s_time_fft=fft(s_time,Nfft+Nf,3);
%     aa=s_time(:,:,1:10)
%     bb=s_time_fft(:,:,1+200:10+200)
