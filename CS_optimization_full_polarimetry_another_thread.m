...
WHEN="0124"
lambda=0.7
experiment_content=  "gradient_descent0124_ppch_window="+window_size+",r="+r+",t="+t+",lambda="+lambda
IF_RANGE
window_size
c=1e-3
tic
...
f_function=[];
for e=-10:0.1:30
    f_function(end+1)=calc_f(s_his_re+e*df_degree,model,p,E_iH,E_iV,FREQ_POINT,WHEN,lambda);
end
figure(2);
plot(d,df_change,'r')
hold on
