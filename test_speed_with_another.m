...
%% 
input_interpolate_array=decide_window(data_size_change(s_use,window_size),window_size);
%% 
CS_optimization_calc_h(input_interpolate_array,model,p,WHEN,lambda);
...
FREQ_POINT=size(input_interpolate_array,3)/4;
Z_NUM=7;
