...
%     [var_x_right_45, var_y_right_45,var_z_right_45,right_45,right_45]=make_plot_order(var_x_right_45_re,var_y_right_45_re,var_z_right_45_re,window_size);
    ...
    [x_back_45,y_back_45,z_back_45,plot_order_back_45,back_45]=make_plot_order_based_on_scattring_matrix(x_back_45_re,y_back_45_re,z_back_45_re,window_size, plot_matrix);
    [x_left_45,y_left_45,z_left_45,plot_order_left_45,left_45]=make_plot_order_based_on_scattring_matrix(x_left_45_re,y_left_45_re,z_left_45_re,window_size, plot_matrix);
    [x_right_45,y_right_45,z_right_45,plot_order_right_45,right_45]=make_plot_order_based_on_scattring_matrix(x_right_45_re,y_right_45_re,z_right_45_re,window_size, plot_matrix);

    [var_x_hori, var_y_hori,var_z_hori,hori,hori]= make_plot_order_based_on_scattring_matrix(x_hori_re,y_hori_re,z_hori_re,window_size, plot_matrix);
    [var_x_ver, var_y_ver,var_z_ver,ver,ver]= make_plot_order_based_on_scattring_matrix(x_ver_re,y_ver_re,z_ver_re,window_size, plot_matrix);
    [var_x_for_45, var_y_for_45,var_z_for_45,for_45,for_45]= make_plot_order_based_on_scattring_matrix(x_for_45_re,y_for_45_re,z_for_45_re,window_size, plot_matrix);
    [var_x_back_45, var_y_back_45,var_z_back_45,back_45,back_45]= make_plot_order_based_on_scattring_matrix(x_back_45_re,y_back_45_re,z_back_45_re,window_size, plot_matrix);
    [var_x_left_45, var_y_left_45,var_z_left_45,left_45,left_45]= make_plot_order_based_on_scattring_matrix(x_left_45_re,y_left_45_re,z_left_45_re,window_size, plot_matrix);
    [var_x_right_45, var_y_right_45,var_z_right_45,right_45,right_45]= make_plot_order_based_on_scattring_matrix(x_right_45_re,y_right_45_re,z_right_45_re,window_size, plot_matrix);
...
% 
    ...
    for i=1:6
        ...
        elseif i==3
            ...
            title(horzcat(plot_name,"+45")); view(fai,theta);
        elseif i==4
        ...
        elseif i==5
            ...
            title(horzcat(plot_name,"left")); view(fai,theta);
        elseif i==6
