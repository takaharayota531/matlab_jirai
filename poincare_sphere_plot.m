...
%     [var_x_right_45, var_y_right_45,var_z_right_45,right_45,right_45]=make_plot_order(var_x_right_45_re,var_y_right_45_re,var_z_right_45_re,window_size);
    ...
    [x_hori,y_hori,z_hori,plot_order_hori,hori1]=make_plot_order_based_on_scattring_matrix(x_hori_re,y_hori_re,z_hori_re,window_size,S_VV);
    [x_ver,y_ver,z_ver,plot_order_ver,ver]=make_plot_order_based_on_scattring_matrix(x_ver_re,y_ver_re,z_ver_re,window_size,S_VV);
    [x_for_45,y_for_45,z_for_45,plot_order_for_45,for_45]=make_plot_order_based_on_scattring_matrix(x_for_45_re,y_for_45_re,z_for_45_re,window_size,S_VV);
    [x_back_45,y_back_45,z_back_45,plot_order_back_45,back_45]=make_plot_order_based_on_scattring_matrix(x_back_45_re,y_back_45_re,z_back_45_re,window_size,S_VV);
    [x_left_45,y_left_45,z_left_45,plot_order_left_45,left_45]=make_plot_order_based_on_scattring_matrix(x_left_45_re,y_left_45_re,z_left_45_re,window_size,S_VV);
    [x_right_45,y_right_45,z_right_45,plot_order_right_45,right_45]=make_plot_order_based_on_scattring_matrix(x_right_45_re,y_right_45_re,z_right_45_re,window_size,S_VV);
