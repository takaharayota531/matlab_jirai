...
reflection_symmetry=s_HH_re.*conj(s_VH_re);
migration_and_plot_polarization(reflection_symmetry,f, horzcat('','reflection symmetry'),depth_start,depth_end);
%% look changhe
ref=angle(reflection_symmetry(:,:,100))
s_hh=angle(s_HH_re(:,:,100))
 %% change
 s=s_VH_re;
%%
